...
//    }
    ...
    public Object addUser(UserInfo userInfo) {
        ...
        if(busOptional.isPresent()){
            ...
            return "Sorry,this user cannot be registered because for his/her location no bus is available in our campus";
        }
    ...
    public Object addBus(BusInfo busInfo) {
        ...
        if (busInfoRepository.existsByLocation(busInfo.getLocation())==false) {
